#import "PicturePreviewPlugin.h"
#import <SDWebImage/SDWebImage.h>

@implementation PicturePreviewPlugin
//组件注册接口，Flutter自动调用
+ (void)registerWithRegistrar:(NSObject<FlutterPluginRegistrar>*)registrar {
  FlutterMethodChannel* channel = [FlutterMethodChannel
      methodChannelWithName:@"com.qidian.image/picture_preview_view"
            binaryMessenger:[registrar messenger]];
  PicturePreviewPlugin* instance = [[PicturePreviewPlugin alloc] init];
